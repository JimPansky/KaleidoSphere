...
function verifyEnvelope(value, action) {
  ...
  if (value.runtime.product.id !== 'superset-bi-agent' || value.runtime.product.version !== 'v0.12.0') fail(`${action}: product mismatch`);
...
if (attestation.product.version !== 'v0.12.0' || attestation.contract.version !== '2.0.0') fail('attestation version mismatch');
