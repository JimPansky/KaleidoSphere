...
const CATALOG_SOURCES = Object.freeze({
  ...
  oracle: new Set([
    'ALL_COL_PRIVS', 'ALL_CONSTRAINTS', 'ALL_CONS_COLUMNS', 'ALL_DEPENDENCIES', 'ALL_INDEXES', 'ALL_IND_COLUMNS',
    'ALL_IND_EXPRESSIONS', 'ALL_OBJECTS', 'ALL_PART_INDEXES',
    'ALL_PART_KEY_COLUMNS', 'ALL_SEQUENCES', 'ALL_SYNONYMS', 'ALL_TAB_COLS', 'ALL_TAB_COLUMNS',
