...
function renderHtml({ evidence, bindings, projections, sourceBindingSha256 }) {
  ...
  return `<!doctype html>
<html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>KaleidoSphere ${escapeHtml(evidence.engine)} structure map</title>
